/*
 * File: app/controller/VATRegistration.js
 *
...
Ext.define('MyApp.controller.VATRegistration', {
    ...
    onVAT_Reg_NextClick: function(button, e, eOpts) {
        var vatReg=Ext.getCmp('VATRegistration');
    ...
    onVAT_Reg_btnSaveClick: function(button, e, eOpts) {
        ...
        var businessTyp="";
        var submissionNo="";
        var busrez=Ext.getCmp('VATRegistration');
        var saveAction="A";
        if(busrez.extraParam)   
        {
            submissionNo = busrez.extraParam.subNo;
            businessTyp = busrez.extraParam.busTyp;
            saveAction=busrez.extraParam.Action;
        }  
        ...
        {
            AddressSNO:busrez.extraParam.businessPersonnelAddressAddressSNo?busrez.extraParam.businessPersonnelAddressAddressSNo:0,
        ...
        var ContactPersonAddress={
            ...
            FromDateHas:'',
            Sno:busrez.extraParam.BusinessPersonnelSNo?busrez.extraParam.BusinessPersonnelSNo:0,
            AddressSNO:busrez.extraParam.businessPersonnelAddressAddressSNo?busrez.extraParam.businessPersonnelAddressAddressSNo:0,
        ...
        Ext.Ajax.request({
            url: '../Handlers/Registration/Taxpayer/TaxpayerInfoHandler.ashx?method=RegisterVatTaxpayer',
            params: {
    ...
    onVATRegistrationAfterRender: function(component, eOpts) {
    ...
    Reload: function() {
        ...
        var VATReg=Ext.getCmp('VATRegistration');
        console.log('VATReg',VATReg);
        if(VATReg)
        {
            var subNo = VATReg.extraParam.subNo; 
            var busType=VATReg.extraParam.busTyp;
            var regFor=VATReg.extraParam.regFor;

            if(regFor==4||regFor==5||regFor==7)
            {
                Ext.ComponentQuery.query('#VAT_Reg_Next')[0].enable();
            ...
            Ext.Ajax.request({
                ...
                success: function ( result, request ) {
                    ...
                    {              
                        ...
                        VATReg.extraParam.Threshold=data.root.Threshold;
                        VATReg.extraParam.Action=businessPersonnel.Action;
                        VATReg.extraParam.BusinessPersonnelSNo= businessPersonnel.SNo;
                        VATReg.extraParam.businessPersonnelAddressAddressSNo= businessPersonnelAddressAddress.AddressSNO;
    ...
    MakeReadOnly: function() {
        var pan=Ext.ComponentQuery.query('#VATRegistration')[0];
    ...
    init: function(application) {
        this.control({
            ...
            "#VATRegistration": {
                afterrender: this.onVATRegistrationAfterRender
            }
        });
    }

/*
 * File: app/controller/ExciseRegistrationAU.js
 *
...
Ext.define('MyApp.controller.ExciseRegistrationAU', {
    ...
    onExciseRegistrationAUStepsAfterRender: function(component, eOpts) {
        var me=this;
        var excReg=Ext.getCmp('ExciseRegistrationAU');
        ...
        Ext.Ajax.request({
            ...
            success: function ( result, request ) {            
                ...
                {
                    ConvertFieldsToReadOnly("ExciseRegistrationAU");
    ...
    onExciseRegistrationAUStepsBeforeTabChange: function(tabPanel, newCard, oldCard, eOpts) {
    ...
    onExcise_Reg_AddPerm_btnAddClick: function(button, e, eOpts) {
        ...
        var exciseReg=Ext.getCmp('ExciseRegistrationAU');
    ...
    onExcise_Reg_AddGoods_btnAddClick: function(button, e, eOpts) {
        ...
        var submissionNo="";
        var exReg=Ext.getCmp('ExciseRegistrationAU');
        if(exReg.extraParam)   
        {
    ...
    onExcise_Reg_Stages_cboPermitChange: function(field, newValue, oldValue, eOpts) {
        ...
        if(newValue)
        {
            ...
            Ext.Ajax.request({
                ...
                params:{
                    submissionNo:Ext.getCmp('ExciseRegistrationAU').extraParam.subNo,
    ...
    onExc_Reg_btnSubmitClick: function(button, e, eOpts) {
        ...
        function(btn) {
            if(btn == 'yes'){
                //////
                var subNo = Ext.getCmp('ExciseRegistrationAU').extraParam.subNo; 
                Ext.Ajax.request({
    ...
    init: function(application) {
        this.control({
            ...
            "#ExciseRegistrationAUSteps": {
                afterrender: this.onExciseRegistrationAUStepsAfterRender,
                beforetabchange: this.onExciseRegistrationAUStepsBeforeTabChange
            },

...
namespace DataObjects
{
    public class OracleError
    {
        public string GetOraError(long lngOraErrorNo,string strError)
        {
            ...
            {
                case 00001:
                    strErrorMsg = "Duplicate data !";
                    break;
                case 12899:
                    strErrorMsg = "Error:Value too Large !";
                    break;
                case 1400:
                     strErrorMsg = "Error: cannot insert NULL into (string)" + "<br>";
                                    strErrorMsg = strErrorMsg + "Cause: An attempt was made to insert a NULL into the column " + "<br>";
                   ...
                   // strErrorMsg = strErrorMsg + "Cause-> An attempt was made to insert a NULL into the column " + "\n";
                  //  strErrorMsg = strErrorMsg + "Action-> Retry the operation with a value other than NULL";
                ...
                case 2290:
                    ...
                    break;
                case 2291:
                    strErrorMsg = "Error: integrity constraint violated";
                ...
                case 20001:
                    ...
                    break;   
                case 06550:
                    strErrorMsg = "Error: Procedure not declared";
                    break;
                default:

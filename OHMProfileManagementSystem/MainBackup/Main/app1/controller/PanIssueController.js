...
Ext.define('MyApp.controller.PanIssue', {
    ...
    onPI_bntPanAllocateClick: function(button, e, options) {
    ...
    onPI_btnCancelClick: function(button, e, options) {
        var me=this;
        me.Clear();
        Ext.ComponentQuery.query('#PI_txtSubNo')[0].focus();
    },

    onPI_txtSubNoKeypress: function(textfield, e, options) {
    ...
    onPI_txtSeriesKeypress: function(textfield, e, options) {
        if(e.keyCode === 13 ||e.keyCode === 9)
        {

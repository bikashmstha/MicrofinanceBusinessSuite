...
Ext.define('MyApp.view.MFAdditonalLoanDisbursement', {
    ...
    onDdlCenterCodeCollapse: function(field, eOpts) {
        Ext.Ajax.request({
                            url:'../Handlers/Finance/Transaction/LoanTransaction/MfAdditionalLoanHandler.ashx',
                            params:{method:'GetMfAdditionalLoan', offCode : getOfficeCode(),
                                    centerCode : Ext.ComponentQuery.query('#ddlCenterCode')[0].getValue(), clientName :null
                },

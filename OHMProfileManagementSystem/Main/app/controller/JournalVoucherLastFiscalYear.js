/*
 * File: app/controller/JournalVoucherLastFiscalYear.js
 *
...
Ext.define('MyApp.controller.JournalVoucherLastFiscalYear', {
    ...
    onFrmJounalVoucherLstFiscalAfterRender: function(component, eOpts) {
    ...
    init: function(application) {
        this.control({
            "#frmJounalVoucherLstFiscal": {
                afterrender: this.onFrmJounalVoucherLstFiscalAfterRender
            },
            "#btnSearch": {

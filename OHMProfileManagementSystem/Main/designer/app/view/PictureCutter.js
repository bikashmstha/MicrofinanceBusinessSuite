                                    ...
                                    items: [
                                        {
                                            ...
                                            handler: function(button, event) {
                                                /*
                                                pictureCutter.objSubmissionNo=submissionNoValue;

                                                pictureCutter.imgPathControlId="#frmEmpImageUpload";
                                                pictureCutter.imgControlId="#frmEmpImageUpload";
                                                pictureCutter.show();
                                                */

                                                var pictureCutter=Ext.ComponentQuery.query('#PictureCutter')[0];

                                                //var submissionNoValue='\\Uploads\\EmployeeImg\\';
                                                var submissionNoValue=pictureCutter.submissionNo;
                                                var imgPathControlId=pictureCutter.imgPathControlId;
                                                var imgControlId=pictureCutter.imgControlId;
                                                var empId=pictureCutter.empId;
                                                var imgName=pictureCutter.imgName;
                                                var imgFolderPath=pictureCutter.imgFolderPath;


                                                console.log('pictureCutter',pictureCutter);
                                                submissionNoValue = pictureCutter.submissionNo;

                                                Ext.Ajax.request({
                                                    url: '../Handlers/Common/PHOTOCutter.ashx',
                                                    params: {
                                                        ...
                                                        submissionNo: submissionNoValue,
                                                        employeeId:empId,
                                                        imgName:imgName
                                                    ...
                                                    success: function(response){
                                                        ...
                                                        var imgsrc=imgFolderPath+responseObj.imgFullName;
                                                        var imgname=responseObj.imgName;
                                                        ...
                                                        //-- Ext.ComponentQuery.query(imgPathControlId)[0].setValue("");
                                                        Ext.ComponentQuery.query(imgPathControlId)[0].imgsrc=imgsrc;

                                                        Ext.ComponentQuery.query(imgPathControlId)[0].setValue(imgname);
                                                        //-- Ext.ComponentQuery.query(imgControlId)[0].setSrc("");
                                                        //alert(imgsrc);
                                                        Ext.ComponentQuery.query(imgControlId)[0].setSrc(imgsrc);
                                                        Ext.ComponentQuery.query("#imgEmployee")[0].imgsrc=imgsrc;

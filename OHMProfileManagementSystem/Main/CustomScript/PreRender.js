		...
		//frame:true,
			loader: {url: 'resources/404.html',
					...
					if(Error.message == "undefined")
						OutResultMessage = "Page Not Found..."
				    else
						OutResultMessage = Error.message;
					
					document.getElementById('ErrorLog').innerHTML='Error Description:-  ' + OutResultMessage;
...
{
   var OutResultMessage="";
	if(nepDate == "")
		{
		   OutResultMessage="Date should not be blank";

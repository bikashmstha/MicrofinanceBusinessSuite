/*
 * File: app/controller/BusinessRegistrationAU.js
 *
...
Ext.define('MyApp.controller.BusinessRegistrationAU', {
    ...
    onBus_Reg_NextClick: function(button, e, eOpts) {
        var busReg=Ext.getCmp('BusinessRegistrationAU');
        var paramm=busReg.extraParam;
        ...
        if(indexOf.call(regFor, "VAT") >=0)
        {

            uiConfig = {menuLink:'VATRegistrationAU',pageTitle:'VAT Registration'};            
            ...
            else if(indexOf.call(regFor, "EXCS") >=0)
            {
                ...
                uiConfig = {menuLink:'ExciseRegistrationAU',pageTitle:'Excise Registration'};            
                DynamicUI(uiConfig,function(){          
                },{pan_no:pan_no,request_no:request_no,office_code:office_code,busTyp:busType,busSubTyp:busSubTyp,regFor:regFor});
    ...
    onBus_Reg_BtnSaveClick: function(button, e, eOpts) {
        ...
        var paramm=Ext.getCmp('BusinessRegistrationAU').extraParam;
        ...
        else
        {
            ...
            mainOfficePlace.FromDate=mainOfficePlace.Action=='A'?nepServerDate:mainOfficePlace.FromDate; 
            mainOfficePlace.AddressType="OA";
            var mainOfficePlaceAddress=mainOfficePlace.Address;

            var mainBusinessPlace=business.MainBusinessPlace;
            mainBusinessPlace.FromDate=mainBusinessPlace.Action=='A'?nepServerDate:mainBusinessPlace.FromDate;
            mainBusinessPlace.AddressType="BA";
            var mainBusinessPlaceAddress=mainBusinessPlace.Address;



            var businessPersonnel=business.BusinessPersonnel;
            businessPersonnel.FromDate=businessPersonnel.Action=='A'?nepServerDate:businessPersonnel.FromDate;
            ...
            businessPersonnelForIT.FromDate=businessPersonnelForIT.Action=='A'?nepServerDate:businessPersonnelForIT.FromDate;
            ...
            //businessPersonnelAddressAddress.Action=businessPersonnel.Action;    
            ...
            //businessPersonnelForITAddressAddress.Action=businessPersonnelForIT.Action; 
        ...
        Ext.Ajax.request({
            url: '../Handlers/Registration/BusinessHandler.ashx?method=SaveBusinessesAU',
            params: {
    ...
    onBus_Reg_btnSubmitClick: function(button, e, eOpts) {
        ...
        function(btn) {  
            if(btn == 'yes'){        
                ...
                Ext.Ajax.request({
                    url: '../Handlers/Registration/BusinessHandler.ashx?method=SaveBusinessesAU',
                    params: { businesses:JSON.stringify( busList)},
                    success: function(response){
                        var text = response.responseText;
                        var resp=Ext.decode(text);  
    ...
    onBusinessRegistrationAUAfterRender: function(component, eOpts) {
        this.ReloadForm();
    },
    ...
    LoadIndividualBusinesses: function() {
        ...
        Ext.Ajax.request({
            url: '../Handlers/Registration/RegistrationsForHandler.ashx?method=IsSubmittedAU',
            params:{pan_no:pan_no,request_no:request_no,office_code:office_code},
            success: function ( result, request ) {            
                var rsp = Ext.decode(result.responseText);
                if(rsp.message=='true'||rsp.message=='True')
                {   
                    ConvertFieldsToReadOnly("BusinessRegistrationAU");
                ...
                Ext.Ajax.request({
                    url: '../Handlers/Registration/BusinessHandler.ashx?method=GetBusinessesAU',
                    params:{pan_no:pan_no,request_no:request_no,office_code:office_code},
                    success: function ( result, request ) {
                        var data = Ext.decode(result.responseText); 
                        var store=Ext.ComponentQuery.query('#Bus_Reg_BusinessList')[0].getStore();
    ...
    ReloadForm: function() {
        ...
        if(indexOf.call(regFor, "VAT") >=0 || indexOf.call(regFor, "EXCS") >=0)
        { 
            Ext.ComponentQuery.query('#Bus_Reg_Next')[0].enable();
    ...
    init: function(application) {
        this.control({
            ...
            "#BusinessRegistrationAU": {
                afterrender: this.onBusinessRegistrationAUAfterRender
            },
            "#Bus_Reg_BtnPrint": {

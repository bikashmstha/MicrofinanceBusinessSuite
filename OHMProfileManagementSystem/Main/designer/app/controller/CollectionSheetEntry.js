/*
 * File: app/controller/CollectionSheetEntry.js
 *
...
Ext.define('MyApp.controller.CollectionSheetEntry', {
    ...
    onBtnLoadSavingDataClick: function(button, e, eOpts) {
        ...
        var collectionDate=Ext.ComponentQuery.query('#txtCollectionDateAD')[0].getValue();
    ...
    onBtnLoadCollectionLoadDataClick: function(button, e, eOpts) {
        var centerCode=Ext.ComponentQuery.query("#txtCenterCode")[0].getValue();
        var collectionSheetNo=Ext.ComponentQuery.query("#txtCollectionSheetNo")[0].getValue();
        var loanCollectionDetailsStore=Ext.getStore('LoanCollectionDetailsStore');
         Ext.Ajax.request
                        ({
                            ...
                            success: function(result, request) {
                                ...
                                if (obj.success == "true")
                                {
                                    ...
                                    loanCollectionDetailsStore.removeAll();
                                    loanCollectionDetailsStore.add(obj.root);
                                }
                                else
                                {
                                     showMessage('WARNING !!!',obj.message);

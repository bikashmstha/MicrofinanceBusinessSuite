/*
 * File: app/view/SelectTransferCenterPopup.js
 *
...
Ext.define('MyApp.view.SelectTransferCenterPopup', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onSelectTransferCenterPopupAfterRender,
                    scope: me
                }
            }
        });
    ...
    onSelectTransferCenterPopupAfterRender: function(component, eOpts) {
        Ext.Ajax.request({
            url:'../Handlers/Finance/Transaction/EditTransaction/LoanTransferFromCenterHandler.ashx',

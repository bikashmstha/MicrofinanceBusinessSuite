...
Ext.define('MyApp.controller.DocumentSearch', {
    ...
    onBtnDSSearchClick: function(button, e, eOpts) {
        ...
        else if(txtDSDocSub.getValue() === "" || txtDSDocSub.getValue() === null)
        {
            count++;
        ...
        else if(txtArDSDocKey.getValue() === "" || txtArDSDocKey.getValue() === null)
        {

            errMsg += "Please fill Document Key !!!";  

        }
        else if(cboDSDocOff.getValue() === "" || cboDSDocOff.getValue() === null)
        {
            count++;
        ...
        else if(txtDSTo.getValue() === "" || txtDSTo.getValue() === null)
        {
            count++;

/*
 * File: app/view/SelectSavingTransferCenterToPopup.js
 *
...
Ext.define('MyApp.view.SelectSavingTransferCenterToPopup', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onSelectSavingTransferCenterToPopupAfterRender,
                    scope: me
                }
            }
        });
    ...
    onSelectSavingTransferCenterToPopupAfterRender: function(component, eOpts) {
        Ext.Ajax.request({
            url:'../Handlers/Finance/Transaction/EditTransaction/SavingTransferFromCenterHandler.ashx',

                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    handler: function(view, rowIndex, colIndex, item, e) {
                                                        ...
                                                        var url = "";
                                                        //console.log('row',row);
                                                        if(row.CloseStatus === "I")
                                                        {
                                                            url = "../Handlers/VAT/RefundPayments/RefundPaymentsHandler2.ashx?method=GetRefundClose" ;
                                                            param = {pan:pan,accttype:accountType,taxyear:taxyear,fileper:fileper,period:period};
                                                        }
                                                        else
                                                        {
                                                            url = "../Handlers/VAT/RefundPayments/RefundPaymentsHandler2.ashx?method=CloneRefundClaim" ;
                                                            param = {offCode:officeCode,accType:accountType,panNo:pan,taxyear:row.TaxYear,fileper:fileper,period:period,appliedDate:row.AppliedDate};
                                                        }

                                                        //string offCode, string accType, string panNo, int taxYear, string filePer,int period,string appliedDate

                                                        //'pan':row.Pan,'accType':'00','taxYear':row.TaxYear,'filper':row.FilPeriod,'period':row.Period,'appDate':row.AppliedDate};
                                                            ...
                                                            success: function ( result, request ) {            
                                                                ...
                                                                {            
                                                                    ...
                                                                    if(obj.total > 0 && data.Status === "I" )
                                                                    {
                                                                        ...
                                                                        Ext.ComponentQuery.query('#txtUserIDRpc')[0].setValue(data.OfficerName);    

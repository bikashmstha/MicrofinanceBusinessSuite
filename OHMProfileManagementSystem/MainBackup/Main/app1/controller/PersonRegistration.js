/*
 * File: app/controller/PersonRegistration.js
 *
...
Ext.define('MyApp.controller.PersonRegistration', {
    ...
    */
    ...
    onBtnSaveClick: function(button, e, eOpts) {
        ...
        if(ePara)
        {
            submissionNo = persRez.extraParam.subNo;
            businessTyp = persRez.extraParam.busTyp;   
            busSubTyp = persRez.extraParam.busSubTyp;
        }
        ...
        var personEPan = 
        {
            ...
            Action : Ext.ComponentQuery.query('#PersonalPanAction')[0].getValue()
        };
    ...
    onBtnSubmitClick: function(button, e, eOpts) {
        ...
        function(btn) {
            if(btn == 'yes'){
                ...
                SubmissionNo  :submissionNo,
                AddressSNO    : ePara.PermanentAddressSno?ePara.PermanentAddressSno:0,
                From_Date     : Ext.decode(AppWakeUpJSON).root.NepaliDate,
                HouseNo       : Ext.ComponentQuery.query('#txtPermanentHouseNo')[0].getValue(),
                WardNo        : Ext.ComponentQuery.query('#txtPermanentWard')[0].getValue(),
                StreetName    : Ext.ComponentQuery.query('#txtPermanentTole')[0].getValue(),
                VdcTown       : Ext.ComponentQuery.query('#txtPermanentVdc')[0].getValue(),
                ...
                AreaCode      : '00',//Ext.ComponentQuery.query('#txtPermanentArea')[0].getValue(),
                status        : '1',
                Action        : ePara.PermanentAddressSno?'E':'A',
                AddressType   : 'P'
                };
                ...
                AddressSNO    : ePara.TemporaryAddressSno?ePara.TemporaryAddressSno:0,
                From_Date     : Ext.decode(AppWakeUpJSON).root.NepaliDate,
                HouseNo       : Ext.ComponentQuery.query('#txtTemporaryHouseNo')[0].getValue(),
                WardNo        : Ext.ComponentQuery.query('#txtTemporaryWard')[0].getValue(),
                StreetName    : Ext.ComponentQuery.query('#txtTemporaryTole')[0].getValue(),
                VdcTown       : Ext.ComponentQuery.query('#txtTemporaryVdc')[0].getValue(),
                LocationType  : locationType1,
                DistrictCode  : Ext.ComponentQuery.query('#cboTemporaryDiscrict')[0].getValue(),
                AreaCode      : '00',//Ext.ComponentQuery.query('#txtTemporaryArea')[0].getValue(),
                status        : '1',
                Action        :  ePara.TemporaryAddressSno?'E':'A',
                AddressType   : 'T'
                };
    ...
    Reload: function() {
        ...
        {   
            console.log('perReg.extraParam',perReg.extraParam);
            var pan=perReg.extraParam.pan;
            if(pan)
            {
                pan = perReg.extraParam.pan;
                var subNo = perReg.extraParam.pan; 
                var busType=perReg.extraParam.busTyp;


                var SubmissionNoAfterLogin = subNo;
                            ...
                            callback: function(records, operation, success) {
                                distReg.load({
                                    ...
                                    callback: function(records, operation, success) {                           
                                        ...
                                        Ext.Ajax.request({
                                            url: '../Handlers/Registration/PersonEPanHandler.ashx?method=GetPersonEPanFromCentral',
                                            params:{pan:pan},
                                            success: function ( result, request ) {

                                                ObjPersonEPAN = Ext.decode(result.responseText);  
                                                console.log('ObjPersonEPAN:',ObjPersonEPAN);
                                                console.log('pInfo :',ObjPersonEPAN.root);
                                                var pInfo=ObjPersonEPAN.root;
                                                console.log('pInfo.LstDocument',pInfo.LstDocument)
                                                DocTypeStore.loadData(pInfo.LstDocument?pInfo.LstDocument:[]);

                                                if(pInfo)
                                                {
                                                    Ext.ComponentQuery.query('#PersonalPanAction')[0].setValue(pInfo.Action=="E"?"E":"A");
                                                    Ext.ComponentQuery.query('#hdnSubmissionNo')[0].setValue(subNo);
                                                    ...
                                                    {
                                                        //Ext.getCmp('imgPerson').setSrc('../../Handlers/PhotoHandle/temp/'+pInfo.SubmissionNo+"/"+pInfo.photo);
                                                    }
                                                    ...
                                                    if(pAddr)
                                                    {
                                                        Ext.getCmp('PersonRegistration').extraParam.PermanentAddressSno=pAddr.AddressSNO;
                                                    ...
                                                    if(tAddr)
                                                    {
                                                        Ext.getCmp('PersonRegistration').extraParam.TemporaryAddressSno=tAddr.AddressSNO;
                                                    ...
                                                    var regFor=perReg.extraParam.regFor;
                                                    ...
                                                    ConvertFieldsToReadOnly("PersonRegistration");
                                                    Ext.ComponentQuery.query('#PerReg_btnAddProf')[0].disable();
                                                    // Ext.ComponentQuery.query('#ppan_print')[0].disable();            
            ...
            {
                var subNo = perReg.extraParam.subNo; 
                var busType=perReg.extraParam.busTyp;
                var regFor=perReg.extraParam.regFor;
                                    ...
                                    callback: function(records, operation, success) {
                                        distReg.load({
                                            ...
                                            callback: function(records, operation, success) {                                        
                                                ...
                                                var ObjPersonEPAN=null;
                                                Ext.Ajax.request({
                                                    url: '../Handlers/Registration/PersonEPanHandler.ashx?method=GetPersonEPan',
                                                    params:{submissionNo:SubmissionNoAfterLogin},
                                                    success: function ( result, request ) {
                                                        ...
                                                        if(pInfo)
                                                        {
                                                            ...
                                                            Ext.ComponentQuery.query('#PersonalPanAction')[0].setValue(pInfo.Action=="E"?"E":"A");
                                                            Ext.ComponentQuery.query('#hdnSubmissionNo')[0].setValue(ObjPersonEPAN.root.SubmissionNo);

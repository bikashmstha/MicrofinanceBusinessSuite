/*
 * File: app/view/SelectLoanPurposePopup.js
 *
...
Ext.define('MyApp.view.SelectLoanPurposePopup', {
            ...
            items: [
                {
                    ...
                    listeners: {
                        afterrender: {
                            fn: me.onSelectLoanPurposePopupAfterRender,
                            scope: me
                        }
                    }
                }
    ...
    onSelectLoanPurposePopupAfterRender: function(component, eOpts) {
        Ext.Ajax.request({
            url:'../Handlers/Finance/Maintenance/LoanPurposeHandler.ashx',
            params:{method:'GetMfLoanPurpose',
                    productCode:Ext.ComponentQuery.query('#txtLoanHeadingCode')[0].getValue(),

/*
 * File: app/view/SelectSavingTransferCenterPopup.js
 *
...
Ext.define('MyApp.view.SelectSavingTransferCenterPopup', {
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            listeners: {
                afterrender: {
                    fn: me.onSelectSavingTransferCenterPopupAfterRender,
                    scope: me
                }
            }
        });
    ...
    onSelectSavingTransferCenterPopupAfterRender: function(component, eOpts) {
        Ext.Ajax.request({
            url:'../Handlers/Finance/Transaction/EditTransaction/SavingTransferFromCenterHandler.ashx',

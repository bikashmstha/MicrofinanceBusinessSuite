/*
 * File: app/view/SelectTransferToMemberPopup.js
 *
...
Ext.define('MyApp.view.SelectTransferToMemberPopup', {
            ...
            items: [
                {
                    ...
                    listeners: {
                        afterrender: {
                            fn: me.onFrmSelectTransferToMemberPopupAfterRender,
                            scope: me
                        }
                    }
                }
    ...
    onFrmSelectTransferToMemberPopupAfterRender: function(component, eOpts) {
        var waitSave = watiMsg('Loading Data. Please wait ...');
        Ext.Ajax.request({
            url:'../Handlers/Finance/Transaction/LoanTransaction/LoanTransferToClientHandler.ashx',
            params:{method:'GetLoanTransferToClient', OfficeCode:getOfficeCode(),

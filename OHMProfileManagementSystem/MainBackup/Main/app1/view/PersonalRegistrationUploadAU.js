/*
 * File: app/view/PersonalRegistrationUploadAU.js
 *
...
Ext.define('MyApp.view.PersonalRegistrationUploadAU', {
    extend: 'Ext.window.Window',

    height: 250,
    id: 'PersonalRegistrationUploadAU',
    itemId: 'PersonalRegistrationUploadAU',
    width: 605,
    resizable: false,
    layout: {
        align: 'stretch',
    ...
    onBtnPersonalRegOkClick: function(button, e, eOpts) {
        if(Ext.ComponentQuery.query('#Pers_Reg_DocumentTxt')[0].getValue())
        {
            ...
            var index=Ext.getCmp('PersonalRegistrationUploadAU').rwindx; 
    ...
    onBtnPersonalRegCancelClick: function(button, e, eOpts) {
        Ext.ComponentQuery.query('#PersonalRegistrationUploadAU')[0].close();
    },

    onFrmPersonalRegUploadAfterRender: function(component, eOpts) {

        var vw=Ext.getCmp('PersonalRegistrationUploadAU');

/*
 * File: app/controller/JournalVoucher.js
 *
...
Ext.define('MyApp.controller.JournalVoucher', {
    ...
    onFrmJournalVoucherAfterRender: function(component, eOpts) {
    ...
    init: function(application) {
        this.control({
            "#frmJournalVoucher": {
                afterrender: this.onFrmJournalVoucherAfterRender
            },
            "#btnSave": {

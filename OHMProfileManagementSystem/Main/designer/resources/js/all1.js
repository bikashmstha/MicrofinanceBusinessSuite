...
siteMaparray[0] ="Integrated Tax Menus@@NULL";
...
function ManageSiteMap(pTitle,plink)
{
	try
	{
	   ...
	   var breadcumb = "Integrated Tax Menus >>" + pTitle;
...
{
		document.title='..::Welcome to Inland Revenue Department Nepal [ '+pageTitle+' ]'
}
...
function waitMsgSuresh(message)
{
	var wait = Ext.MessageBox.wait(message);
	return wait;
}
...
function validateFutureDate(nepDate,futureDate,callback)
{
...
function ConvertFieldsToReadOnly(containerID)
{
	if(containerID)
	{
		var cont=Ext.ComponentQuery.query('#'+containerID)[0];
	    cont.query('.field,.combo').forEach(function(c){c.setReadOnly(true);});
	    cont.query('.grid').forEach(function(c){ c.on('beforeedit', function(editor, e) { return false;});});
	}
	else
	{
        msg('WARNING','No Container ID Provided');
...
function charCodeForPCSFont(e, input)
{
	...
	{
		input.setValue(input.value.substring(0,input.value.length-1));
	}
	switch (unicode) 
	{	
	    case 33: input.setValue(input.value + 'ज्ञ'); return false; break; 
		case 34: input.setValue(input.value + 'ू'); return false; break; 
		case 35: input.setValue(input.value + 'घ'); return false; break;
		case 36: input.setValue(input.value + 'द्ध'); return false; break;
		case 37: input.setValue(input.value + 'छ'); return false; break;
		case 38: input.setValue(input.value + 'ठ'); return false; break;
		case 39: input.setValue(input.value + 'ु'); return false; break;
		case 40: input.setValue(input.value + 'ढ'); return false; break;
		case 41: input.setValue(input.value + 'ण्'); return false; break;
		case 42: input.setValue(input.value + 'ड'); return false; break;
		case 43: input.setValue(input.value + 'ं'); return false; break; 
		//case 44: input.setValue(input.value + ',');return false; break;
		case 45: input.setValue(input.value + ')'); return false; break; 
		case 46: input.setValue(input.value + '।'); return false; break; 
		case 47: input.setValue(input.value + 'र'); return false; break; 
		case 48: input.setValue(input.value + '०'); return false; break; 
	    case 49: input.setValue(input.value + '१'); return false; break; 
		case 50: input.setValue(input.value + '२'); return false; break; 
		case 51: input.setValue(input.value + '३'); return false; break; 
		case 52: input.setValue(input.value + '४'); return false; break; 
		case 53: input.setValue(input.value + '५'); return false; break; 
		case 54: input.setValue(input.value + '६'); return false; break;
		case 55: input.setValue(input.value + '७'); return false; break; 
		case 56: input.setValue(input.value + '८'); return false; break; 
		case 57: input.setValue(input.value + '९'); return false; break; 
		case 58: input.setValue(input.value + 'स्'); return false; break;
		case 59: input.setValue(input.value + 'स'); return false; break; 
		case 60: input.setValue(input.value + '्र'); return false; break; 		
		case 61: input.setValue(input.value + '.'); return false; break;  
		case 62: input.setValue(input.value + 'श्र'); return false; break;  
		case 63: input.setValue(input.value + 'रु'); return false; break;
		case 64:  input.setValue(input.value + 'द्द'); return false; break;
		case 65: input.setValue(input.value + 'ब्'); return false; break;  
		case 66: input.setValue(input.value + 'द्य'); return false; break;    
		case 67: input.setValue(input.value + 'र्'); return false; break;   
		case 68: input.setValue(input.value + 'म्'); return false; break;    
		case 69: input.setValue(input.value + 'भ्'); return false; break;  
		case 70: input.setValue(input.value + 'ा'); return false; break;   
		case 71: input.setValue(input.value + 'न्'); return false; break;  
		case 72: input.setValue(input.value + 'ज्'); return false; break;   
		case 73: input.setValue(input.value + 'क्ष्'); return false; break;  
		case 74: input.setValue(input.value + 'व्'); return false; break;  
		case 75: input.setValue(input.value + 'प्'); return false; break;   
		case 76: input.setValue(input.value + 'ी'); return false; break;   
		case 77: input.setValue(input.value + 'ः'); return false; break;   
		case 78: input.setValue(input.value + 'ल्'); return false; break;    
		case 79: input.setValue(input.value + 'य'); return false; break;    
		case 80: input.setValue(input.value + 'ए'); return false; break;     
		case 81: input.setValue(input.value + 'त्त'); return false; break;     
		case 82: input.setValue(input.value + 'च्'); return false; break;
	    case 83: input.setValue(input.value + 'क्'); return false; break;    
		case 84: input.setValue(input.value + 'त्'); return false; break;    
		case 85: input.setValue(input.value + 'ग्'); return false; break;    
		case 86: input.setValue(input.value + 'ख्'); return false; break;    
		case 87: input.setValue(input.value + 'ध्'); return false; break;    
		case 88: input.setValue(input.value + 'ह्'); return false; break;    
		case 89: input.setValue(input.value + 'थ्'); return false; break;    
		case 90: input.setValue(input.value + 'श्'); return false; break; 
		case 91: input.setValue(input.value + 'ृ'); return false; break;
		case 92: input.setValue(input.value + '्'); return false; break;
      	case 93: input.setValue(input.value + 'े'); return false; break;
		case 94: input.setValue(input.value + 'ट'); return false; break;
		case 95: input.setValue(input.value + '('); return false; break;
		case 96: input.setValue(input.value + 'ञ्'); return false; break;
		case 97: input.setValue(input.value + 'ब'); return false;  break;  
		case 98: input.setValue(input.value + 'द'); return false; break;
		case 99: input.setValue(input.value + 'अ'); return false; break;
		case 100: input.setValue(input.value + 'म'); return false; break;
		case 101: input.setValue(input.value + 'भ'); return false; break;
		case 102: input.setValue(input.value + 'ा'); return false; break;
		case 103: input.setValue(input.value + 'न'); return false; break;
		case 104: input.setValue(input.value + 'ज'); return false; break;
		case 105: input.setValue(input.value + 'ष्'); return false; break;
		case 106: input.setValue(input.value + 'व'); return false; break;
		case 107: input.setValue(input.value + 'प'); return false; break;
		case 108: input.setValue(input.value + 'ि');return false; break;
		case 109: input.setValue(input.value + 'फ'); return false; break;
		case 110: input.setValue(input.value + 'ल'); return false; break;
		case 111: input.setValue(input.value + 'इ'); return false; break;
		case 112: input.setValue(input.value + 'उ'); return false; break;
		case 113: input.setValue(input.value + 'त्र'); return false; break;
		case 114: input.setValue(input.value + 'च'); return false; break;
		case 115: input.setValue(input.value + 'क'); return false; break;
		case 116: input.setValue(input.value + 'त'); return false; break;
		case 117: input.setValue(input.value + 'ग'); return false; break;
		case 118: input.setValue(input.value + 'ख'); return false; break;
		case 119: input.setValue(input.value + 'ध'); return false; break;
		case 120: input.setValue(input.value + 'ह'); return false; break;
		case 121: input.setValue(input.value + 'थ'); return false; break;
		case 122: input.setValue(input.value + 'श'); return false; break;
		case 123: input.setValue(input.value + 'र्'); return false; break;
		case 124: input.setValue(input.value + 'र्'); return false; break;
		case 125: input.setValue(input.value + 'ै'); return false; break;
		case 126: input.setValue(input.value + 'ङ'); return false; break;
	    case 160: input.setValue(input.value + ''); return false; break;
		case 161: input.setValue(input.value + 'ञ्'); return false; break;
		case 162: input.setValue(input.value + 'द्ध'); return false; break;
		case 163: input.setValue(input.value + 'घ्'); return false; break;
		case 164: input.setValue(input.value + 'ँ'); return false; break;
		case 165: input.setValue(input.value + 'ऋ'); return false; break;
		case 167: input.setValue(input.value + 'ट्ट'); return false; break;
		case 169: input.setValue(input.value + '?'); return false; break;
		case 170: input.setValue(input.value + 'ञ'); return false; break;
		case 174: input.setValue(input.value + '+'); return false; break;
		case 176: input.setValue(input.value + 'ङ्क'); return false; break;
		case 177: input.setValue(input.value + 'ऊ'); return false; break;
		case 180: input.setValue(input.value + 'झ'); return false; break;
		case 183: input.setValue(input.value + 'ठ्ठ'); return false; break;
		case 187: input.setValue(input.value + '...'); return false; break;
		case 191: input.setValue(input.value + 'रु'); return false; break;
		case 198: input.setValue(input.value + '”'); return false; break;
		case 210: input.setValue(input.value + 'ू'); return false; break;
		case 212: input.setValue(input.value + 'क्ष'); return false; break;
		case 216: input.setValue(input.value + 'य'); return false; break;
		case 217: input.setValue(input.value + 'ह'); return false; break;
		case 218: input.setValue(input.value + 'ु'); return false; break;
		case 223: input.setValue(input.value + 'द्म'); return false; break;
		case 229: input.setValue(input.value + 'द्व'); return false; break;
		case 230: input.setValue(input.value + '“'); return false; break;
		case 231: input.setValue(input.value + 'ॐ'); return false; break;
		case 233: input.setValue(input.value + 'ङ्ग'); return false; break;
		case 237: input.setValue(input.value + 'ष'); return false; break;
		case 241: input.setValue(input.value + 'ङ'); return false; break;
		case 247: input.setValue(input.value + '/'); return false; break;
		case 250: input.setValue(input.value + 'ू'); return false; break;
	}
}

function unicodeKeyPress(textfield,e, options)
{
	//console.log('unicodeKeyPress');
	return charCodeForPCSFont(e, textfield);
}

function unicodeKeyUp(textfield,e, options)
{
	//console.log('unicodeKeyUp');
...
function unicodeChange(field, newValue, oldValue, options)
{
	...
	var ch2 = field.value.substring( field.value.length -3, field.value.length-2).charCodeAt(0);

	//console.log('charcode',ch2,ch1,ch);
	...
	if ((ch1 === 2366) && (ch === 93))
	{
	    field.setValue(field.value.substring(0,field.value.length-2)+"ो");
	}
	if ((ch1 === 2366) && (ch === 125))
	{
	    field.setValue(field.value.substring(0,field.value.length-2)+"ौ");
	}
	if ((ch1 === 2309) && (ch === 102))
	{
	    field.setValue(field.value.substring(0,field.value.length-2)+"आ");
	}

	if ((ch1 === 2310) && (ch === 93))
	{
	    field.setValue(field.value.substring(0,field.value.length-2)+"ओ");
	}
	if ((ch1 === 2310) && (ch === 125))
	{
	    field.setValue(field.value.substring(0,field.value.length-2)+"औ");
	}
	if ((ch2 === 2311) && (ch === 123))
	{
	    field.setValue(field.value.substring(0,field.value.length-3)+"ई");
	}
	if ((ch1 === 2319) && (ch === 93))
	{
	    field.setValue(field.value.substring(0,field.value.length-2)+"ऐ");
	}
	if ((ch1 === 2338) && (ch === 40))
	{
	    field.setValue(field.value.substring(0,field.value.length-3)+"ढ");
	}
	if ((ch2 === 2339) && (ch === 41))
	{
	    field.setValue(field.value.substring(0,field.value.length-3)+"ण्");
	}
	if ((ch2 === 2339) && (ch === 102))
	{
	    field.setValue(field.value.substring(0,field.value.length-3)+"ण");
	}

}


function unicodeFocus(field, options)
{
	var val =field.value;
	field.setValue(val);
}

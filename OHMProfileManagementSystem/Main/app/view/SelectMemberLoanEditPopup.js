/*
 * File: app/view/SelectMemberLoanEditPopup.js
 *
...
Ext.define('MyApp.view.SelectMemberLoanEditPopup', {
    ...
    height: 500,
    itemId: 'SelectMemberLoanEditPopup',
    width: 1100,
    autoScroll: true,
    layout: 'fit',
    title: 'Select Member',
            ...
            items: [
                {
                    xtype: 'form',
                    frame: true,
                    id: 'frmSelectMemberLoanEditPopup',
    ...
    onRowModelBeforeSelect: function(rowmodel, record, index, eOpts) {
        Ext.MessageBox.confirm('Select', 'Are you sure ?', function(btn){
           ...
           else
           {
            ...
            var v=Ext.ComponentQuery.query('#SelectMemberLoanEditPopup')[0];

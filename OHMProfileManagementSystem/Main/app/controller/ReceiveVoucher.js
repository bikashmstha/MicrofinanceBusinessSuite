/*
 * File: app/controller/ReceiveVoucher.js
 *
...
Ext.define('MyApp.controller.ReceiveVoucher', {
    ...
    stores: [
        ...
        'RecVoucherLoadStore','VoucherDetailsRecStore'
    ],

    onFrmReceiveVoucherMasterAfterRender: function(component, eOpts) {
        ...
        getVoucherAccountLov(OfficeCode=getOfficeCode(),AccountDesc='',function(data){
          ...
          Ext.Ajax.request({
              url: '../Handlers/Finance/AccountTransaction/ReceiptSearchVoucherHandler.ashx',
              params: {
                  method:'GetRcpSearchVoucher',
    ...
    onBtnSearchClick: function(button, e, eOpts) {
        ...
        Ext.Ajax.request
        ({
            url:'../Handlers/Finance/AccountTransaction/ReceiptVoucherMasterDetailHandler.ashx?method=GetReceiptVoucherMstDetail',
    ...
    init: function(application) {
        this.control({
            "#frmReceiveVoucherMaster": {
                afterrender: this.onFrmReceiveVoucherMasterAfterRender
            },
            "#btnSave": {

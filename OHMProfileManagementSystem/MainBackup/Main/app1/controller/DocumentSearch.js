...
Ext.define('MyApp.controller.DocumentSearch', {
    ...
    onFrmDSAfterRender: function(component, eOpts) {
        ...
        Ext.ComponentQuery.query('#cboSection')[0].disable(true);
    },
    ...
    onBtnDSSearchClick: function(button, e, eOpts) {
        ...
        */
        ...
        var status="";
        if(Ext.ComponentQuery.query("#rdDSJuriction")[0].getValue())
        {
            status='J';
        }

        else if(Ext.ComponentQuery.query("#rdDSClassify")[0].getValue())
        {
            status='C';
        }
        else if(Ext.ComponentQuery.query("#rdDSOpen")[0].getValue())
        {
            status='o';
        }
    ...
    onBtnDSCancelClick: function(button, e, eOpts) {
        ...
        cboSection.reset();
        //cboSection.enable(false);
        Ext.ComponentQuery.query('#cboSection')[0].setDisabled(true);
    },
    ...
    onCboDSDocOffChange: function(field, newValue, oldValue, eOpts) {
        ...
        Ext.ComponentQuery.query('#cboSection')[0].enable(true);
    ...
    onRdDSJurictionChange: function(field, newValue, oldValue, eOpts) {
        var rdDSClassify = Ext.ComponentQuery.query("#rdDSClassify")[0];
        var rdDSOpen = Ext.ComponentQuery.query("#rdDSOpen")[0];
        //var grdDSDocSearch = Ext.ComponentQuery.query("#grdDSDocSearch")[0];
    ...
    init: function(application) {
        this.control({
            ...
            "#rdDSJuriction": {
                change: this.onRdDSJurictionChange
            }
        });
    }

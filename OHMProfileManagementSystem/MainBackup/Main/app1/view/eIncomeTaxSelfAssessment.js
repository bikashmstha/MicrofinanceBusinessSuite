/*
 * File: app/view/eIncomeTaxSelfAssessment.js
 *
...
Ext.define('MyApp.view.eIncomeTaxSelfAssessment', {
    ...
    title: 'e-Income Tax Self-Assessment',
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            listeners: {
                                render: {
                                    fn: me.onLblSubmissionNoD03Render,
                                    scope: me
                                }
                            }
                        },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'label',
                            itemId: 'lblIncomeTaxD03',
                            style: 'color:red;\r\ntext-decoration:underline;\r\ncursor:pointer;',
                            text: 'Income Tax Login ',
                            listeners: {
                                render: {
                                    fn: me.onLblIncomeTaxD03Render,
                                    scope: me
                                }
                            }
                        },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'label',
                            itemId: 'lblTaxpayerLoginD03',
                            style: 'color:red;\r\ntext-decoration:underline;\r\ncursor:pointer;',
                            text: 'Taxpayer Login ',
                            listeners: {
                                render: {
                                    fn: me.onLblTaxpayerLoginD03Render,
                                    scope: me
                                }
                            }
                        },
    ...
    onLblSubmissionNoD03Render: function(abstractcomponent, options) {
        var c = abstractcomponent;

        c.getEl().on('click', function(){ this.fireEvent('click', c); }, c);
    },

    onLblIncomeTaxD03Render: function(abstractcomponent, options) {
        var c = abstractcomponent;

        c.getEl().on('click', function(){ this.fireEvent('click', c); }, c);
    },

    onLblTaxpayerLoginD03Render: function(abstractcomponent, options) {
        var c = abstractcomponent;

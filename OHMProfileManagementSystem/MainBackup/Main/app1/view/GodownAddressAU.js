/*
 * File: app/view/GodownAddressAU.js
 *
...
Ext.define('MyApp.view.GodownAddressAU', {
    extend: 'Ext.window.Window',

    id: 'GodownAddressAU',
    itemId: 'GodownAddressAU',
    minHeight: 400,
    minWidth: 700,
    width: 700,
    bodyPadding: 5,
                            ...
                            items: [
                                {
                                    handler: function(view, rowIndex, colIndex, item, e, record, row) {
                                        ...
                                        var gdnAddress=gdn.GodownAddressAU;
    ...
    onExcise_Reg_AddGodown_bnAddGdnClick: function(button, e, eOpts) {
        ...
        { 
            ...
            var GodownAddressAU1=godown1.GodownAddressAU;
            var address1=GodownAddressAU1.Address;      
            ...
            GodownAddressAU1.East=east;
            GodownAddressAU1.West=west;
            GodownAddressAU1.North=north;
            GodownAddressAU1.South=south;
            GodownAddressAU1.Action=GodownAddressAU1.Action=="A"?"A":'E';
            GodownAddressAU1.Address=address1;   

            godown1.FloorArea=floorArea;
            godown1.Purpose=purpose;
            godown1.Action=godown1.Action=="A"?"A":'E';  
            godown1.GodownAddressAU=GodownAddressAU1;        
        ...
        {       
            ...
            var godown={
                ...
                FloorArea:floorArea,
                Action:'A',
                GodownAddressAU:GodownAddressAU
            };
    ...
    onExcise_GodownAddr_btnOkClick: function(button, e, eOpts) {
        var win=Ext.getCmp('GodownAddressAU');
    ...
    onExcise_GodownAddr_btnCancelClick: function(button, e, eOpts) {
        Ext.Msg.confirm('Confirm Action', 'Do you want to Cancel ?', function(btn) {
            if(btn == 'yes'){
                Ext.ComponentQuery.query('#GodownAddressAU')[0].close();
                return true;
            }
        }, this);
    }

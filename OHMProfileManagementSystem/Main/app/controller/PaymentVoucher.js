/*
 * File: app/controller/PaymentVoucher.js
 *
...
Ext.define('MyApp.controller.PaymentVoucher', {
    ...
    stores: [
        ...
        'RecVoucherDetailsStore',
        'RecVoucherSearchStore',
        'RecVoucherLoadStore',
        'VoucherDetailsRecStore'
    ],

    onFrmPaymentVoucherAfterRender: function(component, eOpts) {
        ...
        var storeAccountHeadSearchStore =Ext.getStore('AccountHeadSearchStore');
        var accountDesc='';
        getContraBankAccount(accountDesc,function(data){
            storeAccountHeadSearchStore.removeAll();
            storeAccountHeadSearchStore.add(data.root);
        });
        ...
        var storeRecVoucherDetails =Ext.getStore('RecVoucherDetailsStore');
        getVoucherAccountLov(OfficeCode=getOfficeCode(),AccountDesc='',function(data){
            storeRecVoucherDetails.removeAll();
            storeRecVoucherDetails.add(data.root);
           });


         Ext.Ajax.request({
              url: '../Handlers/Finance/AccountTransaction/PaymentSearchVoucherHandler.ashx',
              params: {
                  method:'GetPaySearchVoucher',
        ...
        var transactionDate='';
        var tranOfficeCode='';
        var accountCode=Ext.ComponentQuery.query('#ddlAccountCode')[0].getValue();

         Ext.Ajax.request({
              url: '../Handlers/Finance/AccountTransaction/BudgetLimitAmtHandler.ashx',
              params: {
                  method:'GetBudgetLimitAmount',
                  FiscalYear:fiscalYear,TransactionDate:transactionDate,TranOfficeCode:getOfficeCode(),AccountCode:accountCode
              },
              success: function(response){
                  var data=Ext.decode(response.responseText);
                  console.log(data);
    ...
    onBtnSearchClick: function(button, e, eOpts) {
        ...
        var voucherNo = Ext.ComponentQuery.query('#ddlVoucherNoSearch')[0].getValue();
        var fromDate = '';
        var toDate = '';
        ...
        Ext.Ajax.request
        ({
            url:'../Handlers/Finance/AccountTransaction/PaymentVoucherMasterDetailHandler.ashx?method=GetPayVoucherMstDetail',
    ...
    init: function(application) {
        this.control({
            "#frmPaymentVoucher": {
                afterrender: this.onFrmPaymentVoucherAfterRender
            },
            "#btnSearch": {

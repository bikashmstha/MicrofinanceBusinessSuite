...
Ext.define('MyApp.controller.DocLoc', {
    ...
    onGrdBuildingItemClick: function(dataview, record, item, index, e, eOpts) {
        ...
        ({
            ...
            success:function(response){
                ...
                Ext.ComponentQuery.query('#hdnBuildingid')[0].setValue(buildingid);
    ...
    onGrdRoomItemClick: function(dataview, record, item, index, e, eOpts) {
        ...
        Ext.ComponentQuery.query('#hdnRoomId')[0].setValue(roomno);
    ...
    onGrdRackItemClick: function(dataview, record, item, index, e, eOpts) {
        ...
        Ext.ComponentQuery.query('#hdnBldIDRack')[0].setValue(buildingid);
        Ext.ComponentQuery.query('#hdnRoomIDRack')[0].setValue(roomno);
        Ext.ComponentQuery.query('#hdnRackid')[0].setValue(rackno);
    ...
    */
    ...
    onBtnSubmitDLClick: function(button, e, eOpts) {
        ...
        var hdnRoomno=Ext.ComponentQuery.query('#hdnRoomId')[0];
        //var hdnRackid=Ext.ComponentQuery.query('#hdnRackid')[0];
        var hdnBuildingid=Ext.ComponentQuery.query('#hdnBuildingid')[0];




        var hdnBldIDRack= Ext.ComponentQuery.query('#hdnBldIDRack')[0];
        var hdnRoomIDRack= Ext.ComponentQuery.query('#hdnRoomIDRack')[0];
        var hdnRackid=Ext.ComponentQuery.query('#hdnRackid')[0];
        ...
        Rack={
            ...
            BUILDING_ID:txtBuildingId===""?hdnBldIDRack.getValue():txtBuildingId,
            ROOM_NO:txtRoomNo===""?hdnRoomIDRack.getValue():txtRoomNo,
            RACK_NO:txtRackNo===""?hdnRackid.getValue():txtRackNo,
        ...
        Ext.Ajax.request({
            ...
            success:function(result,request){
                ...
                Ext.ComponentQuery.query('#hdnOffcode')[0].setValue(cboOffice);
                Ext.ComponentQuery.query('#hdnBuildingid')[0].setValue(hdnBuildingid.getValue());
                Ext.ComponentQuery.query('#hdnRoomId')[0].setValue(hdnRoomIDRack.getValue());

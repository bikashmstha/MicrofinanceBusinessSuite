...
Ext.define('MyApp.controller.DocLoc', {
    ...
    */
    ...
    onBtnSubmitDLClick: function(button, e, eOpts) {
        ...
        if(Ext.ComponentQuery.query('#txtBuildingId')[0].show()===true)
        {
        ...
        if(Ext.ComponentQuery.query('#txtRoomNo')[0].show()===true)
        {
        ...
        if(Ext.ComponentQuery.query('#txtRackNo')[0].show()===true)
        {

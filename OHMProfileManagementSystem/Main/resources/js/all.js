...
siteMaparray[0] ="Document Management System Menus@@NULL";
siteMaparray[1] ="Central Function@@NULL";
siteMaparray[2] ="Look Up Maintenance@@NULL";

function getReferences(value,callback)
{
...
function getNepDate(value,callback)
{
...
function getEngDate(value,callback)
{
...
function getFiscalYears(value,callback)
{
...
function getParticularsLov(particularDesc,callback)
{
	
	Ext.Ajax.request({
		url: '../Handlers/Finance/AccountTransaction/ParticularsHandler.ashx',
		params: {
...
function getVoucherAccountLov(officeCode,accountDesc,callback)
{
	...
	Ext.Ajax.request({
		...
		params: {
			...
			OfficeCode:officeCode,AccountDesc:accountDesc
		},
		success: function(response){
...
function getContraBankAccount(accountDesc,callback)
{
	
	Ext.Ajax.request({
		url: '../Handlers/Finance/AccountTransaction/ContraBankAccountHandler.ashx',
		params: {
			method:'GetContraBnkAcc',
...
function getOfficeLov(userCode,officeName,callback)
{
...
function getOfficeShort(callback)
{
...
function getCasteLov(casteDesc,officeName,callback)
{
...
function getFundingAgencies(callback)
{
...
function getContraAccount(officeCode,accountDesc,callback)
{
...
function getfieldAssistants(officeCode,empName,callback)
{
	...
	Ext.Ajax.request({
		...
		params: {
			...
			officeCode:officeCode,empName:empName
		},
		success: function(response){
...
{
	var loginTitle=Ext.get('LoginTitle').dom.innerHTML;
	return loginTitle.substr(8,loginTitle.length-1);
}

function getMisDateBS()
{
	var misDateBS=Ext.get('misDateBS').dom.innerHTML;
	return misDateBS.substr(0,10);
}
function getMisDateAD()
{
	var misDateAD=Ext.get('misDateAD').dom.innerHTML;
	return misDateAD.substr(0,10);
}
function getFiscalYear()
{
	var fiscalYear=Ext.get('fiscalYear').dom.innerHTML;
	return fiscalYear;
}
...
/*
Ext.Ajax.request({
		url: '../Handlers/Common/Date/DateHandler.ashx?method=GetDates',
		params:{},
...
{
		document.title='..::Microfinance Business Suite [ '+pageTitle+' ]'
}

/*
 * File: app/view/JeopardyAssessment.js
 *
...
Ext.define('MyApp.view.JeopardyAssessment', {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'label',
                            itemId: 'lblSubmissionNoJeo',
                            style: 'color:red;\r\ntext-decoration:underline;\r\ncursor:pointer;',
                            text: 'Get Submission Number ',
                            listeners: {
                                render: {
                                    fn: me.onLblSubmissionNoJeoRender,
                                    scope: me
                                }
                            }
                        },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'label',
                            itemId: 'lblIncomeTaxJeo',
                            style: 'color:red;\r\ntext-decoration:underline;\r\ncursor:pointer;',
                            text: 'Income Tax Login ',
                            listeners: {
                                render: {
                                    fn: me.onLblIncomeTaxJeoRender,
                                    scope: me
                                }
                            }
                        },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'label',
                            itemId: 'lblTaxpayerLoginJeo',
                            style: 'color:red;\r\ntext-decoration:underline;\r\ncursor:pointer;',
                            text: 'Taxpayer Login ',
                            listeners: {
                                render: {
                                    fn: me.onLblTaxpayerLoginJeoRender,
                                    scope: me
                                }
                            }
                        },
    ...
    onLblSubmissionNoJeoRender: function(abstractcomponent, options) {
        var c = abstractcomponent;

        c.getEl().on('click', function(){ this.fireEvent('click', c); }, c);
    },

    onLblIncomeTaxJeoRender: function(abstractcomponent, options) {
        var c = abstractcomponent;

        c.getEl().on('click', function(){ this.fireEvent('click', c); }, c);
    },

    onLblTaxpayerLoginJeoRender: function(abstractcomponent, options) {
        var c = abstractcomponent;
